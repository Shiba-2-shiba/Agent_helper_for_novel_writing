# Skill Regression Boundary Set (2026-03-05)
...
## 14. consistency-auditor
- Input: この章の問題点を優先度付きで診断して。改稿はまだ不要。
- Expected: 監査結果中心で返す。

## 15. consistency-auditor
